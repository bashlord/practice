...
int main()
{
   ...
   while(t--)
   {
       ...
       for(int i=1; i<=lens; i++)
       {
            if(print){
                cout <<"lens:" << lens << endl;
                 cout <<"((LL)(lens-SA[i])*(LL)(lens-SA[i]+1))/211:" << ((LL)(lens-SA[i])*(LL)(lens-SA[i]+1))/211 << endl;
                cout << "((LL)LCP[i]*(LL)(LCP[i]+1))/2ll" <<((LL)LCP[i]*(LL)(LCP[i]+1))/2ll <<endl;
            }
            
           LL p=((LL)(lens-SA[i])*(LL)(lens-SA[i]+1))/2ll- ((LL)LCP[i]*(LL)(LCP[i]+1))/2ll;
       ...
       if(print){
           ...
           cout << "k:" << k<<endl;
           cout << "SA[(int)index]" << SA[(int)index] <<endl;
